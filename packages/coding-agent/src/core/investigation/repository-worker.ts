// Generated from scripts/decider-investigation-access.py; checked by the CPU conformance runner.
export const REPOSITORY_WORKER = String.raw`#!/usr/bin/env python3
